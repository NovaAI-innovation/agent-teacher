...
# Import BaseModel to ensure it's registered with SQLModel.metadata
...
# Set sqlalchemy.url from settings using get_database_url()
# This function handles constructing the URL from config
database_url = get_database_url()
config.set_main_option("sqlalchemy.url", database_url)

# add your model's MetaData object here
# for 'autogenerate' support
# target_metadata should include all model metadata
